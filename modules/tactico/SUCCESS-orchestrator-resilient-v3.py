        ...
        for tab in all_tabs:
            ...
            if tab_count == 0 and new_window:
                ...
                if cmd and cmd.strip():
                    ...
                    debug_log = self.papelera / f"{title.lower()}_boot.log"
                    # Inyección con persistencia: exec cmd; si sale, queda en zsh
                    persist_cmd = f"{cmd} 2> {debug_log}; echo '--- PROCESO FINALIZADO ---' >> {debug_log}; exec zsh -i"
