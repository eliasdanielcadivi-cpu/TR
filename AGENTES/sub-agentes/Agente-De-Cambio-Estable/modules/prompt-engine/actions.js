...
exports.negotiateChange = negotiateChange;
exports.getDefaultPrompt = getDefaultPrompt;
const actions_1 = require("../delta-calculator/actions");
// ============================================================================
// CONSTANTES
// ============================================================================
/**
 ...
 * ```
 */
function updatePrompt(session, newPrompt, force = false) {
    const oldPrompt = session.systemPrompt;
    // Calcular deriva
    const deltaScore = (0, actions_1.calculate)(oldPrompt, newPrompt);
    const needsApproval = (0, actions_1.requiresApproval)(deltaScore);
 ...
 * ```
 */
function negotiateChange(oldPrompt, newPrompt) {
    const comparison = (0, actions_1.compare)(oldPrompt, newPrompt);
