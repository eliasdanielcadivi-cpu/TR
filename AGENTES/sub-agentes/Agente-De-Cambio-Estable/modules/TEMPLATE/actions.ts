 ...
 */
export async function accion1({ param1, param2 }: Params): Promise<Result> {
 ...
 * ```
 */
export async function accion2({ config }: ConfigParams): Promise<void> {
  // Implementación
}
 ...
 * @returns [Tipo] - [Descripción]
 */
export function accion3(input: string): string {
  // Implementación
  return input;
}
